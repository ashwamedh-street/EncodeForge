    ...
    def render_subtitle_settings(self):
        ...
        if enable_download:
            username = st.sidebar.text_input(
                ...
                value=st.session_state.settings.opensubtitles_username
            )
            st.session_state.settings.opensubtitles_username = username
            
            password = st.sidebar.text_input(
                "OpenSubtitles Password",
                value=st.session_state.settings.opensubtitles_password,
                type="password"
            )
            st.session_state.settings.opensubtitles_password = password
    ...
    def render_encoder_tab(self):
        ...
        if st.session_state.files or uploaded_files:
            ...
            if st.button("▶️ Start Conversion", type="primary"):
                st.info("🚧 Conversion logic coming soon!")
        else:
            ...
            if st.button("🎙️ Generate/Download Subtitles", type="primary"):
                if not st.session_state.settings.enable_subtitle_generation and \
                   not st.session_state.settings.enable_subtitle_download:
                    ...
                    st.info("🚧 Subtitle generation logic coming soon!")
        else:
            st.info("👆 Upload files to get started")
        ...
        if uploaded_files:
            ...
            if st.session_state.rename_previews:
                ...
                if st.button("✅ Apply Renames", type="primary"):
                    st.info("🚧 Rename logic coming soon!")
        else:
            st.info("👆 Upload files to get started")
